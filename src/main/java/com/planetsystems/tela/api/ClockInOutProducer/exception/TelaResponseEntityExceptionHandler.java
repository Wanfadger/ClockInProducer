...
import com.planetsystems.tela.api.ClockInOutProducer.dto.SystemErrorDTO;
...
public class TelaResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleAllExceptions(Exception ex, WebRequest request) throws Exception {
        SystemAppFeedBack<SystemErrorDTO> exceptionResponseDTO = new SystemAppFeedBack<SystemErrorDTO>();
